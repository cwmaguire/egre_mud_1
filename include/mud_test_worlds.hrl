...
-define(WORLD_3, [{room,
                  ...
                  ?stamina(p_stamina, player, 1, 100, 10, []),
                  ...
                  ?stamina(z_stamina, zombie, 1, 500, 10, []),
...
-define(WORLD_COMPLETE_QUEST,
        [{room,
         ...
         ?stamina(r_stamina, rat1, 1, 500, 10, [{current, 0}]),
         ...
         ?stamina(r2_stamina, rat2, 1, 500, 10, [{current, 0}]),
         ...
         ?stamina(r3_stamina, rat3, 1, 500, 10, [{current, 0}])]).
