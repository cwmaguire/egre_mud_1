...
-define(WORLD_LIST_QUESTS,
        [{room,
         ...
         {player1,
          [{owner, room},
           {name, <<"P_A_R_D">>},
           {quest, p_quest_1_active_1},
           {quest, p_quest_1_active_2},
           {quest, p_quest_1_ready},
           {quest, p_quest_1_done},
           {icon, person},
           ?CHARACTER_RULES]},

         {p_quest_1_active_1,
          [{owner, player1},
           {name, <<"PQuest 1 Active 1">>},
           {is_complete, false},
           {is_turned_in, false},
           ?QUEST_RULES]},
         ...
         {player2,
          [{owner, room},
           {name, <<"P_A_D">>},
           {quest, p_quest_2_active},
           {quest, p_quest_2_done},
           {icon, person},
           ?CHARACTER_RULES]},

         {p_quest_2_active,
          [{owner, player2},
           {name, <<"PQuest 2 Active">>},
           {is_complete, false},
           {is_turned_in, false},
           ?QUEST_RULES]},
...
-define(WORLD_BUY,
        [{room,
         ...
         {right_glove,
          [{owner, room},
           {name, <<"Right_hand_of_Vecna">>},
           ?ITEM_RULES]}]).

-define(WORLD_MID_ESCROW,
        [{room,
          [{visitor, player},
           {visitor, shopkeeper},
           {name, <<"room 1">>},
         ...
         {shopkeeper,
          [{owner, room},
           ...
           {item, left_glove},
           {cost, #{left_glove => 10}},
           {reserve, {?PID(escrow), ?PID(left_glove)}},
           {money, 2},
           {icon, person},
           ?CHARACTER_RULES]},
